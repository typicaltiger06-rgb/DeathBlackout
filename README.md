[README.md](https://github.com/user-attachments/files/28168027/README.md)
# Death Blackout — Nuclear Option mod

Your screen cuts to black the instant your pilot dies. A dramatic death effect that enhances the immersion of the game.

Optional extras (all configurable): mute all audio on death, and a text line
naming what killed you.
...
- **`Pilot_OnInitialize`** — fires when a fresh pilot spawns; clears the blackout on respawn.
